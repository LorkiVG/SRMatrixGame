...
CMatrixEffect(), m_Radius1(radius1),  m_Radius2(radius2), m_Color1(c1), m_Color2(c2), m_TTL(ttl),m_TTL2(ttl), _m_TTL(INVERT(ttl)), m_Delay(delay), m_Dir(dir), m_AddTactHandler(addtakt)
{
    DTRACE();
...
void CMatrixEffectSpritesLine::Release(void)
{
DTRACE();
...
void CMatrixEffectSpritesLine::Draw(void)
{
    DTRACE();
...
int  CMatrixEffectSpritesLine::Priority(void)
{
