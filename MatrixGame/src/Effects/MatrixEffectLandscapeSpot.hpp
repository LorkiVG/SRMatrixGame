...
public:
    ...
    friend void SpotTactConstant(CMatrixEffectLandscapeSpot *spot, float tact);
    friend void SpotTactAlways(CMatrixEffectLandscapeSpot *spot, float tact);
    friend void SpotTactPlasmaHit(CMatrixEffectLandscapeSpot *spot, float tact);
	friend void SpotTactMoveTo(CMatrixEffectLandscapeSpot *spot, float tact);
    friend void SpotTactPointlight(CMatrixEffectLandscapeSpot *spot, float tact);
    friend void SpotTactVoronka(CMatrixEffectLandscapeSpot *spot, float tact);
