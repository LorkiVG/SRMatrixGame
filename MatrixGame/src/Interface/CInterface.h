...
#define AUTO_ATTACK_ON              SETBIT(1) //јктивирован режим автоматической атаки
#define AUTO_CAPTURE_ON             SETBIT(2) //јктивирован режим автоматического захвата
#define AUTO_PROTECT_ON             SETBIT(3) //јктивирован режим автоматической защиты
...
public:
     ...
     //ѕолноценно инициализируем их в конструкторе
