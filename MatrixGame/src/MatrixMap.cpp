...
void CMatrixMap::OkExitWinHandler(void)
{
    g_MatrixMap->LeaveDialogMode();
...
void CMatrixMap::OkExitLoseHandler(void)
{
    g_MatrixMap->LeaveDialogMode();
...
void CMatrixMap::OkJustExitHandler(void)
{
    g_MatrixMap->LeaveDialogMode();
    SETFLAG(g_Flags, GFLAG_EXITLOOP);
}
void CMatrixMap::OkSurrenderHandler(void)
{
    g_MatrixMap->LeaveDialogMode();
...
void CMatrixMap::OkResetHandler(void)
{
    g_MatrixMap->LeaveDialogMode();
    g_MatrixMap->Restart();
    //g_ExitState = ES_EXIT_AFTER_SURRENDER;
