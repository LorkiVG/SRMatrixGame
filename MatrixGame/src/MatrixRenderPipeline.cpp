...
//    ID3DXBuffer *pVS;
//    ID3DXBuffer *pErr;
//    if (D3D_OK !=  D3DXAssembleShader( cube_map_shader , sizeof(cube_map_shader) -1, nullptr, nullptr, dwFlags , &pVS , &pErr ))
//    {
...
//    pVS->Release();
    ...
    //ASSERT_DX(g_D3DD->CreateCubeTexture(g_MatrixMap->GetReflectionTexture()->GetSizeX(), 1, 0, D3DFMT_X8R8G8B8, D3DPOOL_DEFAULT , &m_CubeTex, nullptr));
    //m_CubeTex->
}

CRenderPipeline::~CRenderPipeline() = default; //{ m_CubeMapShader->Release(); m_VertexDecl->Release(); }