...
float DistLinePoint(
    const D3DXVECTOR3& l1,
    const D3DXVECTOR3& l2,
    const D3DXVECTOR3& p
)
{
    D3DXVECTOR3 v = l2 - l1;
...
bool IntersectLine(
    ...
    const D3DXVECTOR2& e1,
    const D3DXVECTOR2& s2,
    const D3DXVECTOR2& e2,
    D3DXVECTOR2& out
)
{
    float l1x = e1.x - s1.x;
...
void CTrajectory::Init1(
    const D3DXVECTOR3* points,
    int pcnt
)
{
    DTRACE();
