...
//__forceinline void* operator new (size_t size) { return Base::Alloc(size, nullptr); }
//__forceinline void operator delete (void* buf) { Base::Free(buf, nullptr); }
...
//#define HNew(heap) new//new((Base::CHeap*)(heap))
//#define HDelete(aclass, buf, heap) delete buf//{ (buf)->~aclass(); operator delete((buf), ((Base::CHeap*)(heap))); }
