...
png_handle_PLTE(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   if (png_ptr->color_type == PNG_COLOR_TYPE_PALETTE)
   {
      if (info_ptr != 0 && info_ptr->valid & PNG_INFO_tRNS)
      {
...
png_handle_gAMA(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_gAMA
...
png_handle_sBIT(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_sBIT)
   {
...
png_handle_cHRM(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_cHRM
#if defined(PNG_READ_sRGB_SUPPORTED)
      && !(info_ptr->valid & PNG_INFO_sRGB)
#endif
      )
...
png_handle_sRGB(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_sRGB)
   {
...
png_handle_tRNS(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_tRNS)
   {
...
png_handle_bKGD(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_bKGD)
   {
...
png_handle_hIST(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_hIST)
   {
...
png_handle_pHYs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_pHYs)
   {
...
png_handle_oFFs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_oFFs)
   {
...
png_handle_pCAL(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_pCAL)
   {
...
png_handle_tIME(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && info_ptr->valid & PNG_INFO_tIME)
   {
