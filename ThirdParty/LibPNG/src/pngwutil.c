...
png_write_IEND(png_structp png_ptr)
{
   ...
   png_write_chunk(png_ptr, png_IEND, 0, (png_size_t)0);
   ...
   png_size_t text_len, int compression)
{
   ...
   png_charp new_key;
   int i, ret;
   png_charpp output_ptr = 0; /* array of pointers to output */
   ...
   if(text == 0 || *text == '\0' || compression==PNG_TEXT_COMPRESSION_NONE)
   {
